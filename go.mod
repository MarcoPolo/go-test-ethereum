module github.com/marcopolo/go-test-ethereum
...
replace (
	github.com/OffchainLabs/prysm/v7 => ./submodules/prysm
	github.com/ethereum/go-ethereum => ./submodules/go-ethereum
	// Prysm's own replace directives
	github.com/json-iterator/go => github.com/prestonvanloon/go v1.1.7-0.20190722034630-4f2e55fcf87b
	github.com/marcopolo/simnet => ./submodules/simnet
	github.com/tyler-smith/go-bip39 => ./submodules/prysm/third_party/go-bip39
	// Fix ambiguous genproto imports (prysm uses old monolith, geth uses split modules)
